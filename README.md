...
This project houses the base TypeScript template project that I use to create other TypeScript template projects. Please check out https://github.com/ericchase-library/ts-library for other information.
